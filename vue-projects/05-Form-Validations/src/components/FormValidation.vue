...
const clearFormsValue = () => {
  formData.value.name = ''
  formData.value.email = ''
  formData.value.password = ''
  submittedFormStatus.value = false
}
</script>
...
<template>
  <div>
    <form @submit.prevent="submitForm" class="custom-form">
      ...
      <button @:click="clearFormsValue" class="submit-button">
        Reset
      </button>
    </form>
    <div v-if="submittedFormStatus">
      <h1>Submit Forms Value</h1>
